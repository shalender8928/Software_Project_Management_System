...
Route::middleware(['auth', 'CheckRole:Admin'])->group(function () 
{
    ...
    Route::get('select_role_to_update', [AdminController::class, 'select_role_to_update'])->name('admin.select_role_to_update');
    Route::get('update_user_assigned_role/{id}', [AdminController::class, 'update_user_assigned_role'])->name('admin.update_user_assigned_role');
...
Route::middleware(['auth', 'CheckRole:Senior Manager'])->group(function () 
{
  ...
  Route::patch('update_profile_image/{id}', [SeniorManagerController::class, 'update_profile_image']);
   ...
   Route::get('assign_task_update_post/{id}', [ProjectManagerController::class, 'assign_task_update_post']);
