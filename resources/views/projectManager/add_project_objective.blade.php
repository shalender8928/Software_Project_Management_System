                ...
                <div class="col-md-8 col-xl-9 middle-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">Add Project Objective</h6>
                                    <form class="forms-sample" method="POST" action="{{ url('store_project_objective') }}">
                                        @csrf
                                        ...
                                        <!-- Description field -->
                                        <div class="mb-3">
                                            <label class="form-label">Objective Detail</label>
                                            <textarea class="form-control" name="description" rows="5" required></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Click <span style="color: brown ; font-weight:bolder">Go to Scope</span> if Objective  have been added before</label>
                                        </div>

                                        <!-- Submit and Cancel buttons -->
                                        <button type="submit" class="btn btn-primary me-2">Add Objective</button>
                                        <a href="{{url('go_to_scope',$projectPlan->id)}}" class="btn btn-success">Go to Scope</a>
