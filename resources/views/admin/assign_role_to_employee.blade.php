                ...
                <div class="col-md-8 col-xl-9 middle-wrapper">
                  ...
                  <div class="card">
                    <div class="card-body">
                                      ...
                                      <h6 class="card-title">Assign Role to user: <span style="color: aqua">{{$user->firstname}} {{$user->lastname}}</span></h6>
      
                                      <form method="POST" action="{{ route('assign_role_finally', $user->id) }}">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control combo-box" id="role" name="role" required>
                                                <option value="" disabled selected>Select Role by clicking here </option>
