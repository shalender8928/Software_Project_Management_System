                     ...
                     <div class="card rounded">
                       <div class="card-body">
                        <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                            <div class="mb-2">
                            <a href="{{ url('customer_image_edit') }}">
                       ...
                       <div class="card-body">
                                         ...
                                         <form class="forms-sample">
                                            ...
                                            <div class="mb-2">
                                             ...
                                             <a  class="btn btn-primary" href="{{url('/edit_customer_profile')}}">Edit Profile</a>
                                             <a class="btn btn-secondary" href="{{ route('customer.dashboard') }}">Cancel</a>
                                         </form>
                                        </div>
