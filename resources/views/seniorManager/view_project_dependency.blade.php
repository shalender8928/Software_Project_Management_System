                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="preceding_task_id" name="preceding_task_id" onchange="updateTaskOptions()" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="dependent_task_id" name="dependent_task_id" onchange="updatePrecedingTaskOptions()" readonly>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="dependency_type" readonly>
